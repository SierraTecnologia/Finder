...
use Finder\Models\Permissions\PermissionService;
use Finder\Models\User;
use Finder\Models\Components\Book\Book;
use Finder\Models\Components\Book\Bookshelf;
use Finder\Models\Components\Book\Chapter;
use Finder\Models\Components\Book\Entity;
use Finder\Models\Components\Book\EntityProvider;
use Finder\Models\Components\Book\Page;
use Finder\Models\Components\Book\SearchService;
use Finder\Exceptions\NotFoundException;
use Finder\Exceptions\NotifyException;
...
class EntityRepo
{
     ...
     * @return \Finder\Models\Components\Book\Entity
     */
     ...
     * @param \Finder\Models\Components\Book\Bookshelf $bookshelf
     ...
     * @param \Finder\Models\Components\Book\Book $book
     ...
     * Get the child items for a chapter sorted by priority but
     * with draft items floated to the top.
     * @param \Finder\Models\Components\Book\Chapter $chapter
     * @return \Illuminate\Database\Eloquent\Collection|static[]
     */
     ...
     * @param \Finder\Models\Components\Book\Entity $entity
     * @throws \Throwable
     */
     ...
     * Used for books and chapters
     * @param string $type
     * @param \Finder\Models\Components\Book\Entity $entityModel
     * @param array $input
     * @return \Finder\Models\Components\Book\Entity
     */
     ...
     * of book IDs.
     * @param \Finder\Models\Components\Book\Bookshelf $shelf
     * @param string $books
     */
